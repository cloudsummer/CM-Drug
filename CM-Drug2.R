...
setwd("/home/xiay/1_home_xiay/Project/PD1/R/42_CM-Drug_test/3_Nat_immuno_reviewer.use/work_directory_2/")
...
# Declaring Global Variables
inPath = c('Data.2'='Data_A549.2.gctx'
)
...
cat('Loading Data.\n')
referenceRow = cmapR::read_gctx_ids(gctx_path = inPath['Data.2'],
                                    #dimension = 'row'
)
...
library(cmapR)
library(tidyverse)
setwd("~/1_home_xiay/Project/PD1/R/42_CM-Drug_test/3_Nat_immuno_reviewer.use/work_directory_2/")
resultDir="./result/cp/"
...
setwd("/home/xiay/1_home_xiay/Project/PD1/R/42_CM-Drug_test/3_Nat_immuno_reviewer.use/work_directory_2/result/cp/")
load("/home/xiay/1_home_xiay/Project/PD1/R/42_CM-Drug_test/3_Nat_immuno_reviewer.use/work_directory_2/template.RData")
...
library(openxlsx)
openxlsx::write.xlsx(x = drug.choose.detail , file = "./result/cp/results_with_CM_Drug.2.xlsx",
...
rm(list = ls())
setwd("/home/xiay/1_home_xiay/Project/PD1/R/42_CM-Drug_test/3_Nat_immuno_reviewer.use/work2/")
...
library(cmapR)
library(tidyverse)
setwd("~/1_home_xiay/Project/PD1/R/42_CM-Drug_test/3_Nat_immuno_reviewer.use/work2/")
resultDir="./result/cp/"
dir.create(resultDir, recursive = TRUE, showWarnings = FALSE)
load("./template.RData")
...
setwd("/home/xiay/1_home_xiay/Project/PD1/R/42_CM-Drug_test/3_Nat_immuno_reviewer.use/work2/result/cp/")
load("/home/xiay/1_home_xiay/Project/PD1/R/42_CM-Drug_test/3_Nat_immuno_reviewer.use/work2/template.RData")
